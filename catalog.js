...
const CATALOG = [
  {
    ...
    price: '$19 USD',
    chapters: [
      { id: 1, title_es: 'El ruido que nunca para', title_en: 'The Noise That Never Stops', duration: '4min', free: true, audio: 'audio/claridad-mental/es/ch01.mp3', audio_en: 'audio/claridad-mental/en/ch01.mp3' }, // v3 (Nico, 5-sep): grabado con OpenAI TTS (voz "alloy", pipeline/generate_audio.py) — ya no cae al fallback en espanol
