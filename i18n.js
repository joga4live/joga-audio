...
const STRINGS = {
  es: {
    ...
    plan_all_future: 'Todos los libros futuros, mientras te mantengas suscrito',
    plan_all_note: 'Tu precio de renovación queda fijo mientras sigas suscrito sin pausas. Los nuevos suscriptores pagan el precio vigente al momento de unirse.',
  ...
  en: {
    ...
    plan_all_future: 'All future books, for as long as you stay subscribed',
    plan_all_note: 'Your renewal price stays locked as long as you keep renewing without a gap. New subscribers pay the price in effect when they join.',
